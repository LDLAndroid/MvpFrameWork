...
public class ToastLayout extends RelativeLayout {
    ...
    public void showToast(long time){
        ...
        TranslateAnimation trans1 = new TranslateAnimation(0, 0 ,-CommonUtils.dip2px(getContext(),60) ,0);
        TranslateAnimation trans2 = new TranslateAnimation(0,0 , 0 , -CommonUtils.dip2px(getContext(),60));
