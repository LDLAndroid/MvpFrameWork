...
public class PasswordEditText extends AppCompatEditText {
    ...
    private OnPswInputFinishListener onPasswordFullListener;
...
//        }
    ...
    protected void onTextChanged(CharSequence text, int start, int lengthBefore, int lengthAfter) {
        ...
        if (mCurInputCount == mMaxCount && onPasswordFullListener !=null) {
            onPasswordFullListener.pswInputFinish(getPasswordString());
        }
        invalidate();
    }
    /**
     ...
     * 设置密码填充满的监听
     */
    public void setOnPasswordFullListener(OnPswInputFinishListener onPasswordFullListener) {
        this.onPasswordFullListener = onPasswordFullListener;
    }
    ...
    public interface OnPswInputFinishListener {
        void pswInputFinish(String password);
    }
}
