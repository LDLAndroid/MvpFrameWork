...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private com.jungly.gridpasswordview.GridPasswordView.OnPasswordChangedListener mListener;
    ...
    public void openSoftInput() {
        ...
        timer.schedule(new TimerTask() {
            public void run() {
                ...
                inputManager.showSoftInput(mInputView, 0);
            }
    ...
    private void inflaterViews(Context context) {
        ...
        while (index < mPasswordLength) {
            ...
            LinearLayout.LayoutParams dividerParams = new LayoutParams(mLineWidth, LayoutParams.MATCH_PARENT);
     ...
     */
    @Override
    public void setOnPasswordChangedListener(com.jungly.gridpasswordview.GridPasswordView.OnPasswordChangedListener listener) {
